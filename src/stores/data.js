...
export const useActivityStore = defineStore("data", () => {
  ...
  const data = ref({
    "Location 1": {
      ...
      seq: 1,
      task: {
        "<h3>Submit as Video:</h3>Bless someone wearing a cap!": 2,
        "<h3>Submit as Video:</h3>Point at the ceiling and get 10 people to look within 3 minutes!": 3,
        "<h3>Submit as Video:</h3>Do a Tik Tok dance together for 1 min (any dance)!": 2,
      },
      cheat: false,
    },
    ...
    "Location 2": {
      ...
      seq: 2,
      task: {
        "<h3>Submit as Video:</h3>Do the #photocropchallenge as a group!<br><br>Reference Video: ": 2,
        "<h3>Submit as Video:</h3>Make a haiku including the name of any 3 restaurants in aperia!<br><br>\
                (Haikus are a poem of 3 lines, with 5 x 7 x 5 syllables in each line)\
                ": 5,
        "<h3>Submit as Video:</h3>Successfully flip a coin heads 5 times in a row (or tails 5 times in a row)!": 3,
        "<h3>Submit as Picture:</h3>Find shops or products that match all letters of the alphabet. <br>Submit pictures of them in picture (or video) collage!": 5,
      },
      cheat: false,
    },
    ...
    "Location 3": {
      ...
      seq: 3,
      task: {
        "<h3>Submit as Picture:</h3>Take a group jump shot in the reflection of the glass outside the mall!": 2,
        "<h3>Submit as Picture:</h3>It's F46 time! Take a group picture with everyone holding different fitspo poses!": 2,
      },
      cheat: false,
    },
    ...
    "Location 4": {
      ...
      seq: 4,
      task: {
        "<h3>Submit as Video:</h3>Draw each member of your group in 30 seconds! <br>Post it on IG and tag @hopeuni!": 2,
    ...
    "Location 5": {
      ...
      seq: 5,
      task: {
        "<h3>Submit as Video:</h3>As a group, sit down in a circle and face outwards. Link your arms and try to stand up together!<br><br>Reference Video: ": 3,
      },
      cheat: false,
    },
    ...
    "Location 6": {
      ...
      seq: 6,
      task: {
        '<h3>Submit as Picture:</h3>Recreate the mannequin poses<br><br><Image alt="user header" src="mannequin.png" preview />': 2,
        '<h3>Submit as Picture:</h3>Add the total price of all the items on the Tim Ho Wan Menu and use your bodies to form this total price!<br><br><Image alt="user header" src="TimHoWan.jpg" preview />': 3,
      },
      cheat: false,
    },
    ...
    "Location 7": {
      ...
      seq: 7,
      task: {
        "<h3>Submit as Picture:</h3>Find items that add up to $49.75 in total! <br>(show their price tags in submissions)": 5,
        "<h3>Submit as Video:</h3>Record yourselves saying 4 puns that involve cold storage products <br>(1 product for each pun)!": 3,
        "<h3>Submit as Picture:</h3>Find items that start with the first word of every word in this sentence: 'ow xiao fang is the coolest person ever'.": 3,
      },
      cheat: false,
    },
    ...
    "Special Location": {
      ...
      task: {
        "<h3>Submit as Video:</h3>Complete the <b>Human Knot Challenge</b> together!<br><br>\
            Human knot: stand in a circle, reach across and grab hands with 2 different people (not adjacent to yourself).\
            Untangle yourselves without letting go of each other's hands!": 3,
        "<h3>Submit as Video:</h3>One person to piggyback another person and walk from the entrance to this Aperia sign!<br><br><Image alt='user header' src='aperia_sign.png' preview />": 2,
        "<h3>Submit as Video:</h3>As a group, complete 10 pushups, 10 crunches & 10 squats together!": 3,
      },
      cheat: false,
    },
  });
